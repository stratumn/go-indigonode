...
GO_LINT=$(GO_LINT_CMD) --vendor --enable-gc --skip=test --skip=pb --skip=grpc --deadline=2m --disable="vetshadow" --disable="maligned" --disable="ineffassign" --disable="gocyclo" --disable="gas"
