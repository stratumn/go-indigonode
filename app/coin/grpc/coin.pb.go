...
// source: github.com/stratumn/go-indigonode/app/coin/grpc/coin.proto

/*
	Package grpc is a generated protocol buffer package.

	It is generated from these files:
		github.com/stratumn/go-indigonode/app/coin/grpc/coin.proto
...
import stratumn_indigonode_app_coin "github.com/stratumn/go-indigonode/app/coin/pb"
...
type BlockchainResp struct {
	Blocks []*stratumn_indigonode_app_coin.Block `protobuf:"bytes,1,rep,name=blocks" json:"blocks,omitempty"`
}
...
func (m *BlockchainResp) GetBlocks() []*stratumn_indigonode_app_coin.Block {
	if m != nil {
		return m.Blocks
	}
	return nil
...
type TransactionPoolResp struct {
	...
	Txs   []*stratumn_indigonode_app_coin.Transaction `protobuf:"bytes,2,rep,name=txs" json:"txs,omitempty"`
}
...
func (m *TransactionPoolResp) GetTxs() []*stratumn_indigonode_app_coin.Transaction {
	if m != nil {
		return m.Txs
	}
	return nil
...
type CoinClient interface {
	// Get an account.
	GetAccount(ctx context.Context, in *AccountReq, opts ...grpc1.CallOption) (*stratumn_indigonode_app_coin.Account, error)
	// Send a coin transaction to the consensus engine.
	SendTransaction(ctx context.Context, in *stratumn_indigonode_app_coin.Transaction, opts ...grpc1.CallOption) (*TransactionResp, error)
...
func (c *coinClient) GetAccount(ctx context.Context, in *AccountReq, opts ...grpc1.CallOption) (*stratumn_indigonode_app_coin.Account, error) {
	out := new(stratumn_indigonode_app_coin.Account)
...
func (c *coinClient) SendTransaction(ctx context.Context, in *stratumn_indigonode_app_coin.Transaction, opts ...grpc1.CallOption) (*TransactionResp, error) {
...
type Coin_AccountTransactionsClient interface {
	Recv() (*stratumn_indigonode_app_coin.Transaction, error)
	grpc1.ClientStream
}
...
func (x *coinAccountTransactionsClient) Recv() (*stratumn_indigonode_app_coin.Transaction, error) {
	m := new(stratumn_indigonode_app_coin.Transaction)
...
type CoinServer interface {
	// Get an account.
	GetAccount(context.Context, *AccountReq) (*stratumn_indigonode_app_coin.Account, error)
	// Send a coin transaction to the consensus engine.
	SendTransaction(context.Context, *stratumn_indigonode_app_coin.Transaction) (*TransactionResp, error)
	// Get all the past transactions of an account.
...
func _Coin_SendTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	in := new(stratumn_indigonode_app_coin.Transaction)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoinServer).SendTransaction(ctx, req.(*stratumn_indigonode_app_coin.Transaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
type Coin_AccountTransactionsServer interface {
	Send(*stratumn_indigonode_app_coin.Transaction) error
	grpc1.ServerStream
}
...
func (x *coinAccountTransactionsServer) Send(m *stratumn_indigonode_app_coin.Transaction) error {
...
var _Coin_serviceDesc = grpc1.ServiceDesc{
	...
	Metadata: "github.com/stratumn/go-indigonode/app/coin/grpc/coin.proto",
}
...
func (m *BlockchainResp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Blocks = append(m.Blocks, &stratumn_indigonode_app_coin.Block{})
...
func (m *TransactionPoolResp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Txs = append(m.Txs, &stratumn_indigonode_app_coin.Transaction{})
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-indigonode/app/coin/grpc/coin.proto", fileDescriptorCoin)
}
