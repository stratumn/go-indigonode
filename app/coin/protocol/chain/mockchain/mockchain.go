...
// Source: github.com/stratumn/alice/app/coin/protocol/chain (interfaces: Chain)
...
import (
	...
	chain "github.com/stratumn/alice/app/coin/protocol/chain"
	reflect "reflect"
)
...
func (m *MockChain) AddBlock(arg0 *pb.Block) error {
...
func (m *MockChain) CurrentBlock() (*pb.Block, error) {
...
func (m *MockChain) CurrentHeader() (*pb.Header, error) {
...
func (m *MockChain) GetBlock(arg0 []byte, arg1 uint64) (*pb.Block, error) {
...
func (m *MockChain) GetBlockByHash(arg0 []byte) (*pb.Block, error) {
...
func (m *MockChain) GetBlockByNumber(arg0 uint64) (*pb.Block, error) {
...
func (m *MockChain) GetHeaderByHash(arg0 []byte) (*pb.Header, error) {
...
func (m *MockChain) GetHeaderByNumber(arg0 uint64) (*pb.Header, error) {
...
func (m *MockChain) GetHeadersByNumber(arg0 uint64) ([]*pb.Header, error) {
...
func (m *MockChain) GetParentBlock(arg0 *pb.Header) (*pb.Block, error) {
...
func (m *MockChain) SetHead(arg0 *pb.Block) error {
