...
// source: github.com/stratumn/go-node/app/indigo/grpc/fossilizer/fossilizer.proto

/*
	Package fossilizer is a generated protocol buffer package.

	It is generated from these files:
		github.com/stratumn/go-node/app/indigo/grpc/fossilizer/fossilizer.proto
...
func init() {
	proto.RegisterType((*InfoReq)(nil), "stratumn.node.app.indigo.fossilizer.grpc.InfoReq")
	proto.RegisterType((*InfoResp)(nil), "stratumn.node.app.indigo.fossilizer.grpc.InfoResp")
	proto.RegisterType((*FossilizeReq)(nil), "stratumn.node.app.indigo.fossilizer.grpc.FossilizeReq")
	proto.RegisterType((*FossilizeResp)(nil), "stratumn.node.app.indigo.fossilizer.grpc.FossilizeResp")
}
...
func (c *indigoFossilizerClient) GetInfo(ctx context.Context, in *InfoReq, opts ...grpc.CallOption) (*InfoResp, error) {
	out := new(InfoResp)
	err := grpc.Invoke(ctx, "/stratumn.node.app.indigo.fossilizer.grpc.IndigoFossilizer/GetInfo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *indigoFossilizerClient) Fossilize(ctx context.Context, in *FossilizeReq, opts ...grpc.CallOption) (*FossilizeResp, error) {
	...
	err := grpc.Invoke(ctx, "/stratumn.node.app.indigo.fossilizer.grpc.IndigoFossilizer/Fossilize", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IndigoFossilizer_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stratumn.node.app.indigo.fossilizer.grpc.IndigoFossilizer/GetInfo",
	}
...
func _IndigoFossilizer_Fossilize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stratumn.node.app.indigo.fossilizer.grpc.IndigoFossilizer/Fossilize",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _IndigoFossilizer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "stratumn.node.app.indigo.fossilizer.grpc.IndigoFossilizer",
	...
	Metadata: "github.com/stratumn/go-node/app/indigo/grpc/fossilizer/fossilizer.proto",
}
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-node/app/indigo/grpc/fossilizer/fossilizer.proto", fileDescriptorFossilizer)
}
...
var fileDescriptorFossilizer = []byte{
	...
	,
}
