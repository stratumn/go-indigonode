...
// source: github.com/stratumn/go-indigonode/app/indigo/grpc/store/store.proto

/*
	Package store is a generated protocol buffer package.

	It is generated from these files:
		github.com/stratumn/go-indigonode/app/indigo/grpc/store/store.proto
...
import stratumn_indigonode_app_indigo_store "github.com/stratumn/go-indigonode/app/indigo/pb/store"
...
type AddEvidenceReq struct {
	LinkHash *stratumn_indigonode_app_indigo_store.LinkHash `protobuf:"bytes,1,opt,name=link_hash,json=linkHash" json:"link_hash,omitempty"`
	Evidence *stratumn_indigonode_app_indigo_store.Evidence `protobuf:"bytes,2,opt,name=evidence" json:"evidence,omitempty"`
}
...
func (m *AddEvidenceReq) GetLinkHash() *stratumn_indigonode_app_indigo_store.LinkHash {
	if m != nil {
		return m.LinkHash
	}
	return nil
...
func (m *AddEvidenceReq) GetEvidence() *stratumn_indigonode_app_indigo_store.Evidence {
	if m != nil {
		return m.Evidence
	}
	return nil
...
type IndigoStoreClient interface {
	...
	// Create a link.
	CreateLink(ctx context.Context, in *stratumn_indigonode_app_indigo_store.Link, opts ...grpc.CallOption) (*stratumn_indigonode_app_indigo_store.LinkHash, error)
	// Get a segment.
	GetSegment(ctx context.Context, in *stratumn_indigonode_app_indigo_store.LinkHash, opts ...grpc.CallOption) (*stratumn_indigonode_app_indigo_store.Segment, error)
	// Find segments.
	FindSegments(ctx context.Context, in *SegmentFilter, opts ...grpc.CallOption) (*stratumn_indigonode_app_indigo_store.Segments, error)
	// Get map IDs.
	...
	GetEvidences(ctx context.Context, in *stratumn_indigonode_app_indigo_store.LinkHash, opts ...grpc.CallOption) (*stratumn_indigonode_app_indigo_store.Evidences, error)
}
...
func (c *indigoStoreClient) CreateLink(ctx context.Context, in *stratumn_indigonode_app_indigo_store.Link, opts ...grpc.CallOption) (*stratumn_indigonode_app_indigo_store.LinkHash, error) {
	out := new(stratumn_indigonode_app_indigo_store.LinkHash)
...
func (c *indigoStoreClient) GetSegment(ctx context.Context, in *stratumn_indigonode_app_indigo_store.LinkHash, opts ...grpc.CallOption) (*stratumn_indigonode_app_indigo_store.Segment, error) {
	out := new(stratumn_indigonode_app_indigo_store.Segment)
...
func (c *indigoStoreClient) FindSegments(ctx context.Context, in *SegmentFilter, opts ...grpc.CallOption) (*stratumn_indigonode_app_indigo_store.Segments, error) {
	out := new(stratumn_indigonode_app_indigo_store.Segments)
...
func (c *indigoStoreClient) GetEvidences(ctx context.Context, in *stratumn_indigonode_app_indigo_store.LinkHash, opts ...grpc.CallOption) (*stratumn_indigonode_app_indigo_store.Evidences, error) {
	out := new(stratumn_indigonode_app_indigo_store.Evidences)
...
type IndigoStoreServer interface {
	...
	// Create a link.
	CreateLink(context.Context, *stratumn_indigonode_app_indigo_store.Link) (*stratumn_indigonode_app_indigo_store.LinkHash, error)
	// Get a segment.
	GetSegment(context.Context, *stratumn_indigonode_app_indigo_store.LinkHash) (*stratumn_indigonode_app_indigo_store.Segment, error)
	// Find segments.
	FindSegments(context.Context, *SegmentFilter) (*stratumn_indigonode_app_indigo_store.Segments, error)
	// Get map IDs.
	GetMapIDs(context.Context, *MapFilter) (*MapIDs, error)
	// Add evidence to a segment.
	AddEvidence(context.Context, *AddEvidenceReq) (*AddEvidenceResp, error)
	// Get segment evidences.
	GetEvidences(context.Context, *stratumn_indigonode_app_indigo_store.LinkHash) (*stratumn_indigonode_app_indigo_store.Evidences, error)
}
...
func _IndigoStore_CreateLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(stratumn_indigonode_app_indigo_store.Link)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndigoStoreServer).CreateLink(ctx, req.(*stratumn_indigonode_app_indigo_store.Link))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _IndigoStore_GetSegment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(stratumn_indigonode_app_indigo_store.LinkHash)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndigoStoreServer).GetSegment(ctx, req.(*stratumn_indigonode_app_indigo_store.LinkHash))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _IndigoStore_GetEvidences_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndigoStoreServer).GetEvidences(ctx, req.(*stratumn_indigonode_app_indigo_store.LinkHash))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _IndigoStore_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/stratumn/go-indigonode/app/indigo/grpc/store/store.proto",
}
...
func (m *AddEvidenceReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.LinkHash == nil {
				m.LinkHash = &stratumn_indigonode_app_indigo_store.LinkHash{}
			}
		...
		case 2:
			...
			if m.Evidence == nil {
				m.Evidence = &stratumn_indigonode_app_indigo_store.Evidence{}
			}
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-indigonode/app/indigo/grpc/store/store.proto", fileDescriptorStore)
}
