...
/*
	...
	It is generated from these files:
		github.com/stratumn/go-node/app/raft/grpc/raft.proto
...
func (c *raftClient) Start(ctx context.Context, in *Empty, opts ...grpc1.CallOption) (*Empty, error) {
	out := new(Empty)
	err := grpc1.Invoke(ctx, "/stratumn.node.app.raft.grpc.Raft/Start", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) Stop(ctx context.Context, in *Empty, opts ...grpc1.CallOption) (*Empty, error) {
	out := new(Empty)
	err := grpc1.Invoke(ctx, "/stratumn.node.app.raft.grpc.Raft/Stop", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) Status(ctx context.Context, in *Empty, opts ...grpc1.CallOption) (*StatusInfo, error) {
	out := new(StatusInfo)
	err := grpc1.Invoke(ctx, "/stratumn.node.app.raft.grpc.Raft/Status", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) Peers(ctx context.Context, in *Empty, opts ...grpc1.CallOption) (Raft_PeersClient, error) {
	stream, err := grpc1.NewClientStream(ctx, &_Raft_serviceDesc.Streams[0], c.cc, "/stratumn.node.app.raft.grpc.Raft/Peers", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *raftClient) Discover(ctx context.Context, in *PeerID, opts ...grpc1.CallOption) (Raft_DiscoverClient, error) {
	stream, err := grpc1.NewClientStream(ctx, &_Raft_serviceDesc.Streams[1], c.cc, "/stratumn.node.app.raft.grpc.Raft/Discover", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *raftClient) Invite(ctx context.Context, in *PeerID, opts ...grpc1.CallOption) (*Empty, error) {
	out := new(Empty)
	err := grpc1.Invoke(ctx, "/stratumn.node.app.raft.grpc.Raft/Invite", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) Join(ctx context.Context, in *PeerID, opts ...grpc1.CallOption) (*Empty, error) {
	out := new(Empty)
	err := grpc1.Invoke(ctx, "/stratumn.node.app.raft.grpc.Raft/Join", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) Expel(ctx context.Context, in *PeerID, opts ...grpc1.CallOption) (*Empty, error) {
	out := new(Empty)
	err := grpc1.Invoke(ctx, "/stratumn.node.app.raft.grpc.Raft/Expel", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) Propose(ctx context.Context, in *Proposal, opts ...grpc1.CallOption) (*Empty, error) {
	out := new(Empty)
	err := grpc1.Invoke(ctx, "/stratumn.node.app.raft.grpc.Raft/Propose", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) Log(ctx context.Context, in *Empty, opts ...grpc1.CallOption) (Raft_LogClient, error) {
	stream, err := grpc1.NewClientStream(ctx, &_Raft_serviceDesc.Streams[2], c.cc, "/stratumn.node.app.raft.grpc.Raft/Log", opts...)
	if err != nil {
		return nil, err
	}
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-node/app/raft/grpc/raft.proto", fileDescriptorRaft)
}
