...
import stratumn_indigonode_app_storage "github.com/stratumn/go-indigonode/app/storage/pb"
...
type Storage_UploadClient interface {
	Send(*stratumn_indigonode_app_storage.FileChunk) error
...
func (x *storageUploadClient) Send(m *stratumn_indigonode_app_storage.FileChunk) error {
...
type Storage_DownloadClient interface {
	Recv() (*stratumn_indigonode_app_storage.FileChunk, error)
	grpc1.ClientStream
}
...
func (x *storageDownloadClient) Recv() (*stratumn_indigonode_app_storage.FileChunk, error) {
	m := new(stratumn_indigonode_app_storage.FileChunk)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (x *storageUploadServer) Recv() (*stratumn_indigonode_app_storage.FileChunk, error) {
	m := new(stratumn_indigonode_app_storage.FileChunk)
...
func (x *storageDownloadServer) Send(m *stratumn_indigonode_app_storage.FileChunk) error {
	return x.ServerStream.SendMsg(m)
}
