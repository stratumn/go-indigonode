...
package test // import "github.com/stratumn/go-node/cli/grpc/test"
...
func (Message_Enum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_9c513dbb81037864, []int{0, 0}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_9c513dbb81037864, []int{0}
}
...
func (c *testClient) UnaryReq(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/stratumn.node.cli.test.Test/UnaryReq", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testClient) ServerStream(ctx context.Context, in *Message, opts ...grpc.CallOption) (Test_ServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Test_serviceDesc.Streams[0], "/stratumn.node.cli.test.Test/ServerStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testClient) NoExt(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/stratumn.node.cli.test.Test/NoExt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
	...
	for iNdEx < l {
		...
		case 13:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.BooleanRepeated) == 0 {
					m.BooleanRepeated = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
		...
		case 15:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.I32Repeated) == 0 {
					m.I32Repeated = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
		...
		case 17:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.U32Repeated) == 0 {
					m.U32Repeated = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
		...
		case 19:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.I64Repeated) == 0 {
					m.I64Repeated = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
		...
		case 21:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.U64Repeated) == 0 {
					m.U64Repeated = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
		...
		case 31:
			if wireType == 0 {
				...
				var elementCount int
				if elementCount != 0 && len(m.EnumerationRepeated) == 0 {
					m.EnumerationRepeated = make([]Message_Enum, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v Message_Enum
					for shift := uint(0); ; shift += 7 {
		...
		case 55:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.TimeRepeated) == 0 {
					m.TimeRepeated = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
		...
		case 57:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.DurationRepeated) == 0 {
					m.DurationRepeated = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
		...
		case 59:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.BytesizeRepeated) == 0 {
					m.BytesizeRepeated = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
		...
		case 61:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.ByterateRepeated) == 0 {
					m.ByterateRepeated = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-node/cli/grpc/test/test.proto", fileDescriptor_test_9c513dbb81037864)
}

var fileDescriptor_test_9c513dbb81037864 = []byte{
	...
	,
}
