...
import stratumn_indigonode_core_app_bootstrap "github.com/stratumn/go-indigonode/core/app/bootstrap/pb"
...
func (c *bootstrapClient) AddNode(ctx context.Context, in *stratumn_indigonode_core_app_bootstrap.NodeIdentity, opts ...grpc1.CallOption) (*stratumn_indigonode_core_app_bootstrap.Ack, error) {
	out := new(stratumn_indigonode_core_app_bootstrap.Ack)
...
func (c *bootstrapClient) RemoveNode(ctx context.Context, in *stratumn_indigonode_core_app_bootstrap.NodeIdentity, opts ...grpc1.CallOption) (*stratumn_indigonode_core_app_bootstrap.Ack, error) {
	out := new(stratumn_indigonode_core_app_bootstrap.Ack)
...
func (c *bootstrapClient) Accept(ctx context.Context, in *stratumn_indigonode_core_app_bootstrap.PeerID, opts ...grpc1.CallOption) (*stratumn_indigonode_core_app_bootstrap.Ack, error) {
	out := new(stratumn_indigonode_core_app_bootstrap.Ack)
...
func (c *bootstrapClient) Reject(ctx context.Context, in *stratumn_indigonode_core_app_bootstrap.PeerID, opts ...grpc1.CallOption) (*stratumn_indigonode_core_app_bootstrap.Ack, error) {
	out := new(stratumn_indigonode_core_app_bootstrap.Ack)
...
func (c *bootstrapClient) List(ctx context.Context, in *stratumn_indigonode_core_app_bootstrap.Filter, opts ...grpc1.CallOption) (Bootstrap_ListClient, error) {
...
func (x *bootstrapListClient) Recv() (*stratumn_indigonode_core_app_bootstrap.UpdateProposal, error) {
	m := new(stratumn_indigonode_core_app_bootstrap.UpdateProposal)
...
func (c *bootstrapClient) Complete(ctx context.Context, in *stratumn_indigonode_core_app_bootstrap.CompleteReq, opts ...grpc1.CallOption) (*stratumn_indigonode_core_app_bootstrap.Ack, error) {
	out := new(stratumn_indigonode_core_app_bootstrap.Ack)
...
func _Bootstrap_AddNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	in := new(stratumn_indigonode_core_app_bootstrap.NodeIdentity)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BootstrapServer).AddNode(ctx, req.(*stratumn_indigonode_core_app_bootstrap.NodeIdentity))
	}
...
func _Bootstrap_RemoveNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BootstrapServer).RemoveNode(ctx, req.(*stratumn_indigonode_core_app_bootstrap.NodeIdentity))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Bootstrap_Accept_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	in := new(stratumn_indigonode_core_app_bootstrap.PeerID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BootstrapServer).Accept(ctx, req.(*stratumn_indigonode_core_app_bootstrap.PeerID))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Bootstrap_Reject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BootstrapServer).Reject(ctx, req.(*stratumn_indigonode_core_app_bootstrap.PeerID))
	}
	return interceptor(ctx, in, info, handler)
}

func _Bootstrap_List_Handler(srv interface{}, stream grpc1.ServerStream) error {
	m := new(stratumn_indigonode_core_app_bootstrap.Filter)
...
func (x *bootstrapListServer) Send(m *stratumn_indigonode_core_app_bootstrap.UpdateProposal) error {
...
func _Bootstrap_Complete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	in := new(stratumn_indigonode_core_app_bootstrap.CompleteReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BootstrapServer).Complete(ctx, req.(*stratumn_indigonode_core_app_bootstrap.CompleteReq))
	}
	return interceptor(ctx, in, info, handler)
}
