...
type Vote struct {
	...
	Challenge  []byte                                     `protobuf:"bytes,3,opt,name=challenge,proto3" json:"challenge,omitempty"`
	Signature  *stratumn_indigonode_core_crypto.Signature `protobuf:"bytes,4,opt,name=signature" json:"signature,omitempty"`
}
...
func (m *Vote) GetSignature() *stratumn_indigonode_core_crypto.Signature {
	if m != nil {
		return m.Signature
	}
	return nil
