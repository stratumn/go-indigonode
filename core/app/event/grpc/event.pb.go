...
/*
	...
	It is generated from these files:
		github.com/stratumn/go-node/core/app/event/grpc/event.proto
...
func (c *emitterClient) Listen(ctx context.Context, in *ListenReq, opts ...grpc1.CallOption) (Emitter_ListenClient, error) {
	stream, err := grpc1.NewClientStream(ctx, &_Emitter_serviceDesc.Streams[0], c.cc, "/stratumn.node.core.app.event.grpc.Emitter/Listen", opts...)
	if err != nil {
		return nil, err
	}
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-node/core/app/event/grpc/event.proto", fileDescriptorEvent)
}
