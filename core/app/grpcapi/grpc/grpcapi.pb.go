...
/*
	...
	It is generated from these files:
		github.com/stratumn/go-node/core/app/grpcapi/grpc/grpcapi.proto
...
func (c *aPIClient) Inform(ctx context.Context, in *InformReq, opts ...grpc1.CallOption) (*Info, error) {
	out := new(Info)
	err := grpc1.Invoke(ctx, "/stratumn.node.core.app.grpcapi.grpc.API/Inform", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-node/core/app/grpcapi/grpc/grpcapi.proto", fileDescriptorGrpcapi)
}
