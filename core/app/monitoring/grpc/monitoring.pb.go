...
/*
	...
	It is generated from these files:
		github.com/stratumn/go-node/core/app/monitoring/grpc/monitoring.proto
...
func (c *monitoringClient) SetSamplingRatio(ctx context.Context, in *SamplingRatio, opts ...grpc1.CallOption) (*Ack, error) {
	out := new(Ack)
	err := grpc1.Invoke(ctx, "/stratumn.node.core.app.monitoring.grpc.Monitoring/SetSamplingRatio", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-node/core/app/monitoring/grpc/monitoring.proto", fileDescriptorMonitoring)
}
