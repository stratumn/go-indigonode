...
// Source: github.com/stratumn/go-indigonode/core/app/swarm/grpc (interfaces: Swarm_PeersServer,Swarm_ConnectionsServer,Swarm_AddressesServer)
...
import (
	...
	grpc "github.com/stratumn/go-indigonode/core/app/swarm/grpc"
...
// MockSwarm_AddressesServer is a mock of Swarm_AddressesServer interface
type MockSwarm_AddressesServer struct {
	ctrl     *gomock.Controller
	recorder *MockSwarm_AddressesServerMockRecorder
}

// MockSwarm_AddressesServerMockRecorder is the mock recorder for MockSwarm_AddressesServer
type MockSwarm_AddressesServerMockRecorder struct {
	mock *MockSwarm_AddressesServer
}

// NewMockSwarm_AddressesServer creates a new mock instance
func NewMockSwarm_AddressesServer(ctrl *gomock.Controller) *MockSwarm_AddressesServer {
	mock := &MockSwarm_AddressesServer{ctrl: ctrl}
	mock.recorder = &MockSwarm_AddressesServerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockSwarm_AddressesServer) EXPECT() *MockSwarm_AddressesServerMockRecorder {
	return m.recorder
}

// Context mocks base method
func (m *MockSwarm_AddressesServer) Context() context.Context {
	ret := m.ctrl.Call(m, "Context")
	ret0, _ := ret[0].(context.Context)
	return ret0
}
...
// Context indicates an expected call of Context
func (mr *MockSwarm_AddressesServerMockRecorder) Context() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Context", reflect.TypeOf((*MockSwarm_AddressesServer)(nil).Context))
}

// RecvMsg mocks base method
func (m *MockSwarm_AddressesServer) RecvMsg(arg0 interface{}) error {
	ret := m.ctrl.Call(m, "RecvMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// RecvMsg indicates an expected call of RecvMsg
func (mr *MockSwarm_AddressesServerMockRecorder) RecvMsg(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecvMsg", reflect.TypeOf((*MockSwarm_AddressesServer)(nil).RecvMsg), arg0)
}

// Send mocks base method
func (m *MockSwarm_AddressesServer) Send(arg0 *grpc.PeerAddr) error {
	ret := m.ctrl.Call(m, "Send", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// Send indicates an expected call of Send
func (mr *MockSwarm_AddressesServerMockRecorder) Send(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockSwarm_AddressesServer)(nil).Send), arg0)
}

// SendHeader mocks base method
func (m *MockSwarm_AddressesServer) SendHeader(arg0 metadata.MD) error {
	ret := m.ctrl.Call(m, "SendHeader", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// SendHeader indicates an expected call of SendHeader
func (mr *MockSwarm_AddressesServerMockRecorder) SendHeader(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendHeader", reflect.TypeOf((*MockSwarm_AddressesServer)(nil).SendHeader), arg0)
}

// SendMsg mocks base method
func (m *MockSwarm_AddressesServer) SendMsg(arg0 interface{}) error {
	ret := m.ctrl.Call(m, "SendMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// SendMsg indicates an expected call of SendMsg
func (mr *MockSwarm_AddressesServerMockRecorder) SendMsg(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMsg", reflect.TypeOf((*MockSwarm_AddressesServer)(nil).SendMsg), arg0)
}

// SetHeader mocks base method
func (m *MockSwarm_AddressesServer) SetHeader(arg0 metadata.MD) error {
	ret := m.ctrl.Call(m, "SetHeader", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// SetHeader indicates an expected call of SetHeader
func (mr *MockSwarm_AddressesServerMockRecorder) SetHeader(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetHeader", reflect.TypeOf((*MockSwarm_AddressesServer)(nil).SetHeader), arg0)
}

// SetTrailer mocks base method
func (m *MockSwarm_AddressesServer) SetTrailer(arg0 metadata.MD) {
	m.ctrl.Call(m, "SetTrailer", arg0)
}

// SetTrailer indicates an expected call of SetTrailer
func (mr *MockSwarm_AddressesServerMockRecorder) SetTrailer(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetTrailer", reflect.TypeOf((*MockSwarm_AddressesServer)(nil).SetTrailer), arg0)
}
