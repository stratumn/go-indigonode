...
/*
	...
	It is generated from these files:
		github.com/stratumn/go-node/core/manager/grpc/manager.proto
...
func (c *managerClient) List(ctx context.Context, in *ListReq, opts ...grpc1.CallOption) (Manager_ListClient, error) {
	stream, err := grpc1.NewClientStream(ctx, &_Manager_serviceDesc.Streams[0], c.cc, "/stratumn.node.core.manager.grpc.Manager/List", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *managerClient) Info(ctx context.Context, in *InfoReq, opts ...grpc1.CallOption) (*Service, error) {
	out := new(Service)
	err := grpc1.Invoke(ctx, "/stratumn.node.core.manager.grpc.Manager/Info", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) Start(ctx context.Context, in *StartReq, opts ...grpc1.CallOption) (*Service, error) {
	out := new(Service)
	err := grpc1.Invoke(ctx, "/stratumn.node.core.manager.grpc.Manager/Start", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) Stop(ctx context.Context, in *StopReq, opts ...grpc1.CallOption) (*Service, error) {
	out := new(Service)
	err := grpc1.Invoke(ctx, "/stratumn.node.core.manager.grpc.Manager/Stop", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) Prune(ctx context.Context, in *PruneReq, opts ...grpc1.CallOption) (Manager_PruneClient, error) {
	stream, err := grpc1.NewClientStream(ctx, &_Manager_serviceDesc.Streams[1], c.cc, "/stratumn.node.core.manager.grpc.Manager/Prune", opts...)
	if err != nil {
		return nil, err
	}
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-node/core/manager/grpc/manager.proto", fileDescriptorManager)
}
