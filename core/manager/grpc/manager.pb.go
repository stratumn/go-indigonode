...
type Service struct {
	Id        string         `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Status    Service_Status `protobuf:"varint,2,opt,name=status,proto3,enum=stratumn.alice.core.manager.grpc.Service_Status" json:"status,omitempty"`
...
func init() {
	proto.RegisterType((*ListReq)(nil), "stratumn.alice.core.manager.grpc.ListReq")
	proto.RegisterType((*InfoReq)(nil), "stratumn.alice.core.manager.grpc.InfoReq")
	proto.RegisterType((*StartReq)(nil), "stratumn.alice.core.manager.grpc.StartReq")
	proto.RegisterType((*StopReq)(nil), "stratumn.alice.core.manager.grpc.StopReq")
	proto.RegisterType((*PruneReq)(nil), "stratumn.alice.core.manager.grpc.PruneReq")
	proto.RegisterType((*Service)(nil), "stratumn.alice.core.manager.grpc.Service")
	proto.RegisterEnum("stratumn.alice.core.manager.grpc.Service_Status", Service_Status_name, Service_Status_value)
}
...
func (c *managerClient) List(ctx context.Context, in *ListReq, opts ...grpc1.CallOption) (Manager_ListClient, error) {
	stream, err := grpc1.NewClientStream(ctx, &_Manager_serviceDesc.Streams[0], c.cc, "/stratumn.alice.core.manager.grpc.Manager/List", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *managerClient) Info(ctx context.Context, in *InfoReq, opts ...grpc1.CallOption) (*Service, error) {
	out := new(Service)
	err := grpc1.Invoke(ctx, "/stratumn.alice.core.manager.grpc.Manager/Info", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) Start(ctx context.Context, in *StartReq, opts ...grpc1.CallOption) (*Service, error) {
	out := new(Service)
	err := grpc1.Invoke(ctx, "/stratumn.alice.core.manager.grpc.Manager/Start", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) Stop(ctx context.Context, in *StopReq, opts ...grpc1.CallOption) (*Service, error) {
	out := new(Service)
	err := grpc1.Invoke(ctx, "/stratumn.alice.core.manager.grpc.Manager/Stop", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) Prune(ctx context.Context, in *PruneReq, opts ...grpc1.CallOption) (Manager_PruneClient, error) {
	stream, err := grpc1.NewClientStream(ctx, &_Manager_serviceDesc.Streams[1], c.cc, "/stratumn.alice.core.manager.grpc.Manager/Prune", opts...)
	if err != nil {
		return nil, err
	}
...
func _Manager_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc1.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stratumn.alice.core.manager.grpc.Manager/Info",
	}
...
func _Manager_Start_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc1.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stratumn.alice.core.manager.grpc.Manager/Start",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_Stop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc1.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stratumn.alice.core.manager.grpc.Manager/Stop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Manager_serviceDesc = grpc1.ServiceDesc{
	ServiceName: "stratumn.alice.core.manager.grpc.Manager",
