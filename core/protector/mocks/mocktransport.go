...
func (m *MockConn) Transport() go_libp2p_transport.Transport {
...
func (mr *MockConnMockRecorder) Transport() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Transport", reflect.TypeOf((*MockConn)(nil).Transport))
}
