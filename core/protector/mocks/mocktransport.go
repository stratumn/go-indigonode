...
func (_m *MockConn) LocalMultiaddr() go_multiaddr.Multiaddr {
	ret := _m.ctrl.Call(_m, "LocalMultiaddr")
	ret0, _ := ret[0].(go_multiaddr.Multiaddr)
	return ret0
}

// LocalMultiaddr indicates an expected call of LocalMultiaddr
func (_mr *MockConnMockRecorder) LocalMultiaddr() *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "LocalMultiaddr", reflect.TypeOf((*MockConn)(nil).LocalMultiaddr))
}
...
func (_m *MockConn) RemoteMultiaddr() go_multiaddr.Multiaddr {
	ret := _m.ctrl.Call(_m, "RemoteMultiaddr")
	ret0, _ := ret[0].(go_multiaddr.Multiaddr)
	return ret0
}

// RemoteMultiaddr indicates an expected call of RemoteMultiaddr
func (_mr *MockConnMockRecorder) RemoteMultiaddr() *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "RemoteMultiaddr", reflect.TypeOf((*MockConn)(nil).RemoteMultiaddr))
}
...
func (_m *MockConn) Transport() go_libp2p_transport.Transport {
...
func (_mr *MockConnMockRecorder) Transport() *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "Transport", reflect.TypeOf((*MockConn)(nil).Transport))
}
