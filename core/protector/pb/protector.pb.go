...
// source: github.com/stratumn/go-node/core/protector/pb/protector.proto

package pb // import "github.com/stratumn/go-node/core/protector/pb"
...
type NetworkConfig struct {
	NetworkState         NetworkState          `protobuf:"varint,1,opt,name=network_state,json=networkState,proto3,enum=stratumn.node.core.protector.NetworkState" json:"network_state,omitempty"`
...
func init() {
	proto.RegisterType((*PeerAddrs)(nil), "stratumn.node.core.protector.PeerAddrs")
	proto.RegisterType((*NetworkConfig)(nil), "stratumn.node.core.protector.NetworkConfig")
	proto.RegisterMapType((map[string]*PeerAddrs)(nil), "stratumn.node.core.protector.NetworkConfig.ParticipantsEntry")
	proto.RegisterEnum("stratumn.node.core.protector.NetworkState", NetworkState_name, NetworkState_value)
}
...
func init() {
	proto.RegisterFile("github.com/stratumn/go-node/core/protector/pb/protector.proto", fileDescriptor_protector_339e2fbbb8a3ce27)
}
