...
// CircleProcess exports internal circle process structure
type CircleProcess interface {
...
func (c *circleProcess) eventCircle(ctx context.Context, rd lib.Ready) {
	...
	for _, entry := range rd.CommittedEntries() {
		...
		case lib.EntryConfChange:
			...
			cc, err := c.lib.UnmarshalConfChange(entry.Data())
			if err != nil {
