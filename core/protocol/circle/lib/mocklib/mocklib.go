...
// Source: github.com/stratumn/alice/core/protocol/circle/lib (interfaces: Lib)
...
// UnmarshalConfChange mocks base method
func (m *MockLib) UnmarshalConfChange(arg0 []byte) (lib.ConfChange, error) {
	ret := m.ctrl.Call(m, "UnmarshalConfChange", arg0)
	ret0, _ := ret[0].(lib.ConfChange)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UnmarshalConfChange indicates an expected call of UnmarshalConfChange
func (mr *MockLibMockRecorder) UnmarshalConfChange(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UnmarshalConfChange", reflect.TypeOf((*MockLib)(nil).UnmarshalConfChange), arg0)
}
