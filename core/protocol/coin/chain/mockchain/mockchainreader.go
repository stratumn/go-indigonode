...
func (m *MockReader) CurrentHeader() *coin.Header {
...
func (m *MockReader) GetBlock(arg0 []byte, arg1 uint64) *coin.Block {
...
func (m *MockReader) GetHeaderByHash(arg0 []byte) *coin.Header {
...
func (m *MockReader) GetHeaderByNumber(arg0 uint64) []*coin.Header {
