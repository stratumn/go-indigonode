...
func (m *MockValidator) ValidateBlock(arg0 *coin.Block, arg1 state.Reader) error {
...
func (m *MockValidator) ValidateTransactions(arg0 []*coin.Transaction, arg1 state.Reader) error {
...
func (m *MockValidator) ValidateTx(arg0 *coin.Transaction, arg1 state.Reader) error {
