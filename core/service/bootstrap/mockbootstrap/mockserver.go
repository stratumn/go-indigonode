...
// Source: github.com/stratumn/alice/grpc/bootstrap (interfaces: Bootstrap_ListServer)
...
func (m *MockBootstrap_ListServer) Send(arg0 *bootstrap.UpdateProposal) error {
