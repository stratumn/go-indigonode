...
func (m *MockEmitter) AddListener() <-chan *event.Event {
...
func (mr *MockEmitterMockRecorder) AddListener() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddListener", reflect.TypeOf((*MockEmitter)(nil).AddListener))
}
...
func (m *MockEmitter) GetListenersCount() int {
	ret := m.ctrl.Call(m, "GetListenersCount")
	ret0, _ := ret[0].(int)
	return ret0
}

// GetListenersCount indicates an expected call of GetListenersCount
func (mr *MockEmitterMockRecorder) GetListenersCount() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetListenersCount", reflect.TypeOf((*MockEmitter)(nil).GetListenersCount))
}
