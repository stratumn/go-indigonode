...
func (_m *MockHost) SetIDService(_param0 *identify.IDService) {
	_m.ctrl.Call(_m, "SetIDService", _param0)
}

// SetIDService indicates an expected call of SetIDService
func (_mr *MockHostMockRecorder) SetIDService(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "SetIDService", reflect.TypeOf((*MockHost)(nil).SetIDService), arg0)
}
