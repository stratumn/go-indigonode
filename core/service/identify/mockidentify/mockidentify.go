...
// Source: github.com/stratumn/alice/core/service/identify (interfaces: Host)
...
func (m *MockHost) SetIDService(arg0 *identify.IDService) {
	m.ctrl.Call(m, "SetIDService", arg0)
}
...
func (mr *MockHostMockRecorder) SetIDService(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetIDService", reflect.TypeOf((*MockHost)(nil).SetIDService), arg0)
}
