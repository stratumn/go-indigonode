...
func (_m *MockHost) SetRouter(_param0 func(context.Context, go_libp2p_peer.ID) (go_libp2p_peerstore.PeerInfo, error)) {
	_m.ctrl.Call(_m, "SetRouter", _param0)
}

// SetRouter indicates an expected call of SetRouter
func (_mr *MockHostMockRecorder) SetRouter(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "SetRouter", reflect.TypeOf((*MockHost)(nil).SetRouter), arg0)
}
