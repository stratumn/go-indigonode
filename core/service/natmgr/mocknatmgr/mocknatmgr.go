...
// Source: github.com/stratumn/alice/core/service/natmgr (interfaces: Host)

// Package mocknatmgr is a generated GoMock package.
package mocknatmgr
...
import (
	...
	basic "gx/ipfs/QmXGfPjhnro8tgANHDUg4gGgLGYnAz1zcDPAgNeUkzbsN1/go-libp2p/p2p/host/basic"
	go_libp2p_peerstore "gx/ipfs/QmXauCuJzmzapetmC6W4TuDJLL1yFFrVzSHoWv8YdbmnxH/go-libp2p-peerstore"
	go_libp2p_net "gx/ipfs/QmXfkENeeBvh3zYA51MaSdGUdBjhQ99cP5WQe8zgr6wchG/go-libp2p-net"
	...
	go_libp2p_interface_connmgr "gx/ipfs/Qmax8X1Kfahf5WfSB68EWDG3d3qyS3Sqs1v412fjPTfRwx/go-libp2p-interface-connmgr"
	reflect "reflect"
)
...
// SetNATManager mocks base method
func (m *MockHost) SetNATManager(arg0 basic.NATManager) {
	m.ctrl.Call(m, "SetNATManager", arg0)
}

// SetNATManager indicates an expected call of SetNATManager
func (mr *MockHostMockRecorder) SetNATManager(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetNATManager", reflect.TypeOf((*MockHost)(nil).SetNATManager), arg0)
}
