...
func (_m *MockHost) SetNATManager(_param0 basic.NATManager) {
	_m.ctrl.Call(_m, "SetNATManager", _param0)
}

// SetNATManager indicates an expected call of SetNATManager
func (_mr *MockHostMockRecorder) SetNATManager(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "SetNATManager", reflect.TypeOf((*MockHost)(nil).SetNATManager), arg0)
}
