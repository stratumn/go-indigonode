...
func (_ raftImpl) NewMemoryStorage() lib.Storage {
	return raftStorageImpl{
		s: raft.NewMemoryStorage(),
	}
}

func (_ raftImpl) StartNode(c lib.Config, pp []lib.Peer) lib.Node {
...
func (_ raftImpl) NewConfChange(id uint64, ccType lib.ConfChangeType, nodeID uint64, context []byte) lib.ConfChange {
...
func (_ raftImpl) UnmarshalConfChange(data []byte) (lib.ConfChange, error) {
	cc := raftpb.ConfChange{}
...
func (_ raftImpl) NewConfig(id uint64, electionTick int, heartbeatTick int, storage lib.Storage, maxSizePerMsg uint64, maxInflightMsgs int) lib.Config {
...
func (_ raftImpl) NewPeer(id uint64, context []byte) lib.Peer {
	return raftPeerImpl{
		p: raft.Peer{
			ID:      id,
			Context: context,
...
func (r raftReadyImpl) CommittedEntries() []lib.Entry {
	...
	for i, _ := range r.r.CommittedEntries {
