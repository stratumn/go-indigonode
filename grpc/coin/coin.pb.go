...
type CoinClient interface {
	// Get an account.
	GetAccount(ctx context.Context, in *AccountReq, opts ...grpc.CallOption) (*stratumn_alice_pb_coin.Account, error)
	// Send a coin transaction to the consensus engine.
	SendTransaction(ctx context.Context, in *stratumn_alice_pb_coin.Transaction, opts ...grpc.CallOption) (*TransactionResp, error)
...
func (c *coinClient) GetAccount(ctx context.Context, in *AccountReq, opts ...grpc.CallOption) (*stratumn_alice_pb_coin.Account, error) {
	out := new(stratumn_alice_pb_coin.Account)
	err := grpc.Invoke(ctx, "/stratumn.alice.grpc.coin.Coin/GetAccount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coinClient) SendTransaction(ctx context.Context, in *stratumn_alice_pb_coin.Transaction, opts ...grpc.CallOption) (*TransactionResp, error) {
	out := new(TransactionResp)
	err := grpc.Invoke(ctx, "/stratumn.alice.grpc.coin.Coin/SendTransaction", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coinClient) TransactionPool(ctx context.Context, in *TransactionPoolReq, opts ...grpc.CallOption) (*TransactionPoolResp, error) {
	...
	err := grpc.Invoke(ctx, "/stratumn.alice.grpc.coin.Coin/TransactionPool", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptorCoin = []byte{
	...
	,
}
